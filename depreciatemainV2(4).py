...
def fetchFromChampionGGApi(rank,championId):
	...
	if(rank == 'BRONZE'):
		...
		championGGtier = 'PLATINUM,DIAMOND,MASTER,CHALLENGER'


	#Char global winrate
	if(unranked == True):
		call = "api.champion.gg/v2/champions/"+str(championId)+"&api_key="+championGGApiKey
	else:
		call = "api.champion.gg/v2/champions/"+str(championId)+'?elo='+str(championGGtier)+"&api_key="+championGGApiKey
...
def leaguePointToElo(tier, rank, leaguePoints):
	...
	if(tier == "BRONZE"):
		if(rank == "V"):
			return 0+869*(1-leaguePoints/100)
		if(rank == "IV"):
			return 870+69*(1-leaguePoints/100)
		if(rank == "III"):
			return 940+69*(1-leaguePoints/100)
		if(rank == "II"):
			return 1010+69*(1-leaguePoints/100)
		if(rank == "I"):
			return 1080+69*(1-leaguePoints/100)

	elif(tier == "SILVER"):
		if(rank == "V"):
			return 1150+69*(1-leaguePoints/100)
		if(rank == "IV"):
			return 1220+69*(1-leaguePoints/100)
		if(rank == "III"):
			return 1290+69*(1-leaguePoints/100)
		if(rank == "II"):
			return 1360+69*(1-leaguePoints/100)
		if(rank == "I"):
			return 1430+69*(1-leaguePoints/100)

	elif(tier == "GOLD"):
		if(rank == "V"):
			return 1500+69*(1-leaguePoints/100)
		if(rank == "IV"):
			return 1570+69*(1-leaguePoints/100)
		if(rank == "III"):
			return 1640+69*(1-leaguePoints/100)
		if(rank == "II"):
			return 1710+69*(1-leaguePoints/100)
		if(rank == "I"):
			return 1780+69*(1-leaguePoints/100)

	elif(tier == "PLATINUM"):
		if(rank == "V"):
			return 1850+69*(1-leaguePoints/100)
		if(rank == "IV"):
			return 1920+69*(1-leaguePoints/100)
		if(rank == "III"):
			return 1990+69*(1-leaguePoints/100)
		if(rank == "II"):
			return 2060+69*(1-leaguePoints/100)
		if(rank == "I"):
			return 2130+69*(1-leaguePoints/100)
	elif(tier == "DIAMOND"):
		if(rank == "V"):
			return 2200+69*(1-leaguePoints/100)
		if(rank == "IV"):
			return 2270+69*(1-leaguePoints/100)
		if(rank == "III"):
			return 2340+69*(1-leaguePoints/100)
		if(rank == "II"):
			return 2410+69*(1-leaguePoints/100)
		if(rank == "I"):
			return 2480+69*(1-leaguePoints/100)
	elif(tier == "MASTER"):
		#We estimate that challenger ~= master 400 lp
		return 2585+349*(1-leaguePoints/400)
...
def getRecentGame():
	...
	if(jsonData != False):
		for game in jsonData["gameList"]:
			...
			return game["gameId"]
			'''if(game['gameQueueConfigId'] == srDraft or game['gameQueueConfigId'] == srRankedSolo or game['gameQueueConfigId'] == srBlindPick or game['gameQueueConfigId'] == srRankedFlex):
				return game["gameId"]
			'''
...
key = 'RGAPI-93afebfd-5754-4b66-a4ed-96ce8173e926'
championGGApiKey='NOKEYYET'
